...
SECRET_KEY = 'django-insecure-gp$1uqfva&)xetr=ydr(k)w#1o4yett1!o#qjd^+w6-i+!pcc#'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'SmartClaim',  # your DB name
        'USER': 'postgres',    # your DB username
        'PASSWORD': '123456',  # your postgres password
        'HOST': 'localhost',
        'PORT': '5432',
    }
}
...
DEFAULT_FROM_EMAIL = config('EMAIL_HOST_USER', default='noreply@smartclaim.com')
SMARTCLAIM_PORTAL_URL = config('SMARTCLAIM_PORTAL_URL', default='http://localhost:3000')